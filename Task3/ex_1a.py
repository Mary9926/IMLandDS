...
all_dfs2 = all_dfs.groupby(['name'])['count'].sum()
all_df3 = all_dfs2, all_dfs(['sex'])
print(all_df3)

# girls_names = all_dfs2(['name', 'sex'] == ['M']), all_dfs2['count']
...
# print(girls_names)
# girls_names = all_dfs2(['name'], ['count']) and (all_dfs2['sex'] == "M")
# print(girls_names)
